...
#define AK09916__WIA2 0x01  //AK09916器件ID寄存器地址
#define AK09916__CNTL 0x31  //AK09916控制寄存器
#define AK09916__CNTL2 0x32  //AK09916控制寄存器2
...
#define ICM20948_ACCEL_CONFIG 0x14  //加速度计配置寄存器
#define ICM20948_GYRO_SMPLRT_DIV 0x00  //陀螺仪采样率分频寄存器
#define ICM20948_GYRO_CONFIG_1 0x01  //陀螺仪计配置寄存器1
#define ICM20948_GYRO_CONFIG_2 0x02  //陀螺仪计配置寄存器1
#define ICM20948_FIFO_EN_1 0x66   //FIFO使能寄存器1
#define ICM20948_FIFO_EN_2 0x67   //FIFO使能寄存器2
...
#define ICM20948_INT_PIN_CFG 0x0F  //中断/旁路设置寄存器
...
#define ICM20948_PWR_MGMT_1 0x06  //电源管理寄存器1
#define ICM20948_PWR_MGMT_2 0x07  //电源管理寄存器2
#define ICM20948_WHO_AM_I 0x00  //器件ID寄存器
